...
function changeColor(cell) {
    let current_row = Math.floor((option - 1) / 6) + 1;
    for (let i = option; i <= current_row * 6; i += 1) {
...
my_cell.addEventListener('dblclick', () => changeColor(my_cell));
